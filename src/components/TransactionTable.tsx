...
function FinancialItem({title,value,color}:FinancialItemProps){
  return(
    <Grid item xs={4} textAlign={'center'} >
      ...
      <Typography sx={{color: color, fontSize:{xs:'.8rem', sm:'1rem', md:'1.2rem'},wordBreak:'break-word'}} fontWeight={'fontWeightBold'} component={'span'} >￥{formatCurrency(value)}</Typography>
      </Grid>
    )
  }
